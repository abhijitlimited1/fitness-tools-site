...
// Function to get icon based on tool title
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
      <div className="p-6">
        <div className="flex items-start mb-4">
          <div className="flex-shrink-0 bg-blue-100 p-2 rounded-md text-blue-600 mr-4">
            {getToolIcon(title)}
          </div>
          <div>
        ...
        <Link
          to={link}
          className="w-full inline-flex items-center justify-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors font-medium"
        >
          Use Tool
          <svg
            xmlns="http://www.w3.org/2000/svg"
